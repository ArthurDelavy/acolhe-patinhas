...
public class AnimalLaboratoryTestResultController {
    ...
    public ResponseEntity<List<ResumedLaboratoryTestResultResponse>> listByAnimal(@PathVariable int animalId) {
    ...
    public ResponseEntity<LaboratoryTestResultResponse> newLabTest(@PathVariable int animalId, @RequestBody @Valid NewLaboratoryTestResultRequest data) {
