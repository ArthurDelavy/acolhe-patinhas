...
public class ReferencesService {
    ...
    @Cacheable(value = "animalSpecie", key = "#id")
    public AnimalSpecie getSpecie(int id) {
        return spcRep.findById(id).orElseThrow(() -> new ValueNotFoundException("Espécie não encontrada."));
    }
    ...
    @Caching(evict = {
        @CacheEvict(value = "animalBreeds", allEntries = true),
        @CacheEvict(value = "animalBreed", key = "#breedId")
    })
    ...
    @Caching(evict = {
        @CacheEvict(value = "animalSpecies", allEntries = true),
        @CacheEvict(value = "animalSpecie", key = "#specieId")
    })
    ...
    @Caching(evict = {
        @CacheEvict(value = "animalColors", allEntries = true),
        @CacheEvict(value = "animalColor", key = "#colorId")
    })
    ...
    @Caching(evict = {
        @CacheEvict(value = "animalDischargeReasons", allEntries = true),
        @CacheEvict(value = "animalDischargeReason", key = "#reasonId")
    })
