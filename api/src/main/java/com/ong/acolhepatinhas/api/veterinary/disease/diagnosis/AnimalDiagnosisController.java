...
public class AnimalDiagnosisController {
    ...
    public ResponseEntity<List<DiagnosisResponse>> listByAnimal(@RequestParam int animalId) {
    ...
    public ResponseEntity<Void> newDiagnosis(@RequestParam int animalId, @RequestBody @Valid NewDiagnosisRequest data) {
