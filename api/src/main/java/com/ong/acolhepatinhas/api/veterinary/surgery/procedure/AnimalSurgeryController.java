...
public class AnimalSurgeryController {
    ...
    public ResponseEntity<List<SurgeryResponse>> listByAnimal(@PathVariable int animalId) {
    ...
    public ResponseEntity<SurgeryResponse> newSurgery(@PathVariable int animalId, @RequestBody @Valid NewSurgeryRequest data) {
